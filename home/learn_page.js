const learn_page = $('div[efy_content=learn]'),
...
$add('div', {efy_tabs: 'home_tabs'}, [
    ['div', {class: 'efy_tabs'}, [
        ['input', {efy_tab: 'home_tab_start', efy_searchable: 'start', type: 'radio', id: 'home_tab_start', name: 'home_tabs', efy_active: ''}],
        ['label', {for: 'home_tab_start'}, 'Start'],
        ['input', {efy_tab: 'home_tab_questions', efy_searchable: 'questions', type: 'radio', id: 'home_tab_questions', name: 'home_tabs'}],
        ['label', {for: 'home_tab_questions'}, 'Questions'],
        ['input', {efy_tab: 'home_tab_common_actions', efy_searchable: 'common_actions', type: 'radio', id: 'home_tab_common_actions', name: 'home_tabs'}],
        ['label', {for: 'home_tab_common_actions'}, 'Common Actions'],
        ['input', {efy_tab: 'home_tab_html', efy_searchable: 'html', type: 'radio', id: 'home_tab_html', name: 'home_tabs'}],
        ['label', {for: 'home_tab_html'}, 'HTML Examples'],
        ['input', {efy_tab: 'home_tab_variables', efy_searchable: 'css_variables', type: 'radio', id: 'home_tab_variables', name: 'home_tabs'}],
        ['label', {for: 'home_tab_variables'}, 'CSS Variables'],
        ['input', {efy_tab: 'home_tab_modes', efy_searchable: 'modes', type: 'radio', id: 'home_tab_modes', name: 'home_tabs'}],
        ['label', {for: 'home_tab_modes'}, 'Modes'],
        ['input', {efy_tab: 'home_tab_modules', efy_searchable: 'modules', type: 'radio', id: 'home_tab_modules', name: 'home_tabs'}],
        ['label', {for: 'home_tab_modules'}, 'Modules'],
        ['input', {efy_tab: 'home_tab_icons', efy_searchable: 'icons', type: 'radio', id: 'home_tab_icons', name: 'home_tabs'}],
        ['label', {for: 'home_tab_icons'}, 'Icons'],
        ['input', {efy_tab: 'home_tab_shapes', efy_searchable: 'shapes', type: 'radio', id: 'home_tab_shapes', name: 'home_tabs'}],
        ['label', {for: 'home_tab_shapes'}, 'Shapes'],
        ['input', {efy_tab: 'home_tab_themes', efy_searchable: 'themes', type: 'radio', id: 'home_tab_themes', name: 'home_tabs'}],
        ['label', {for: 'home_tab_themes'}, 'Themes'],

        ['div', {class: 'group home_tab_group_components'}, [
            ['input', {
                type: 'checkbox', id: 'home_tab_group_components', name: 'home_tabs', efy_searchable: 'components',
                efy_toggle: '.home_tab_group_components :is(input, label):not(#home_tab_group_components, [for=home_tab_group_components])'
            }],
            ['label', {for: 'home_tab_group_components', class: 'summary'}, 'Components'],
            ['input', {efy_tab: 'home_tab_clock', efy_searchable: 'clock', type: 'radio', id: 'home_tab_clock', name: 'home_tabs', class: 'efy_hide_i'}],
            ['label', {for: 'home_tab_clock', class: 'efy_hide_i'}, 'Clock'],
            ['input', {efy_tab: 'home_tab_color_picker', efy_searchable: 'color-picker', type: 'radio', id: 'home_tab_color_picker', name: 'home_tabs', class: 'efy_hide_i'}],
            ['label', {for: 'home_tab_color_picker', class: 'efy_hide_i'}, 'Color Picker'],
            ['input', {efy_tab: 'home_tab_notifications', efy_searchable: 'notifications', type: 'radio', id: 'home_tab_notifications', name: 'home_tabs', class: 'efy_hide_i'}],
            ['label', {for: 'home_tab_notifications', class: 'efy_hide_i'}, 'Notifications'],
            ['input', {efy_tab: 'home_tab_select_menu', efy_searchable: 'select_menu', type: 'radio', id: 'home_tab_select_menu', name: 'home_tabs', class: 'efy_hide_i'}],
            ['label', {for: 'home_tab_select_menu', class: 'efy_hide_i'}, 'Select Menu'],
            ['input', {efy_tab: 'home_tab_tabs', efy_searchable: 'tabs', type: 'radio', id: 'home_tab_tabs', name: 'home_tabs', class: 'efy_hide_i'}],
            ['label', {for: 'home_tab_tabs', class: 'efy_hide_i'}, 'Tabs'],
            ['input', {efy_tab: 'home_tab_timer', efy_searchable: 'timer', type: 'radio', id: 'home_tab_timer', name: 'home_tabs', class: 'efy_hide_i'}],
            ['label', {for: 'home_tab_timer', class: 'efy_hide_i'}, 'Timer']
        ]],

        ['div', {class: 'group home_tab_group_functions'}, [
            ['input', {
                type: 'checkbox', id: 'home_tab_group_functions', name: 'home_tabs', efy_searchable: 'functions',
                efy_toggle: '.home_tab_group_functions :is(input, label):not(#home_tab_group_functions, [for=home_tab_group_functions])'
            }],
            ['label', {for: 'home_tab_group_functions', class: 'summary'}, 'Functions'],
            ['input', {efy_tab: 'home_tab_add', efy_searchable: 'add', type: 'radio', id: 'home_tab_add', name: 'home_tabs'}],
            ['label', {for: 'home_tab_add', class: 'efy_hide_i'}, '$add - create html']
        ]]
    ]],

    ['div', {efy_content: 'home_tab_start', efy_active: '', class: 'efy_shadow_card_off efy_card_filter_off'}, [
    ...
    ['div', {efy_content: 'home_tab_questions', class: 'efy_shadow_card_off efy_card_filter_off'}, [
        ...
        ['details', {efy_searchable: 'status'}, [
            ...
            ['hr', {style: 'margin: 0'}], ['p', 'If you\'re a dev, wait for the home to add explainations on how to use it before adding it to your apps']
        ]],
        ['details', {efy_searchable: 'name'}, [
            ['summary', [['p','What does '], ['code', 'EFY'], ['p', ' mean?']]],
            ['p', 'Nothing. It\'s just a name, like Andy or Izzy.']
        ]],
        ['details', {efy_searchable: 'set_background'}, [
            ['summary', 'Add background images / videos'],
            ['p', [
                ['mark', 'EFY'], ['i', {efy_icon: 'chevron'}],
                ['mark', {efy_lang: 'theme'}], ['i', {efy_icon: 'chevron'}],
                ['mark', {efy_lang: 'mode'}], ['i', {efy_icon: 'chevron'}],
                ['mark', {efy_lang: 'background'}], ['i', {efy_icon: 'chevron'}],
    ...
    ['div', {efy_content: 'home_tab_common_actions', class: 'efy_shadow_card_off efy_card_filter_off'}, [
        ['h4', 'Common Actions'], ['p', `Coming soon...`],
    ]],

    ['div', {efy_content: 'home_tab_html', class: 'efy_shadow_card_off efy_card_filter_off'}, [
        ['p', {style: 'margin-bottom: 15rem', efy_searchable: ''}, 'Examples of HTML elements styled with efy:'],
        ['div', {efy_searchable: '', class: 'hm_grid'}, [
            ['div', [
                ['figure', [
        ...
        ['div', {efy_searchable: '', id: 'hm_headings'}, [
        ...
        ['div', {id: 'hm_lists', efy_searchable: ''}, [
            ['ul', [
                ['li', 'List item'],
        ...
        ['div', {efy_searchable: '', id: 'hm_lists'}, [
            ['div', [ ['h6', 'Pre'], ['pre', 'div {\n  color: var(--text);\n  background: var(--bg);\n}'] ]],
            ['div', [ ['h6', 'Pre > Code'], ['pre', [['code', 'div {\n  color: var(--text);\n  background: var(--bg);\n}']]] ]],
            ['div', { 'efy_searchable': '' }, [
                ['h6', 'Article'],
                ['article', { 'class': 'efy_shadow_card' }, [ ['h4', 'H3'], ['p', 'Paragraph inside an article'] ]]
            ]],
            ['div', { 'efy_searchable': '' }, [
                ['h6', 'Blockquote'],
        ...
        ['div', { 'efy_searchable': '' }, [ ['form', [
                ['fieldset', { 'class': 'hm_grid' }, [
                    ...
                    ['div', { 'id': 'hm_lists', 'style': 'margin: 0' }, [
                ...
                ['div', { 'efy_searchable': '', 'id': 'hm_buttons' }, [
                    ['button', 'button'],
    ...
    ['div', {efy_content: 'home_tab_variables', class: 'efy_card_filter_off'}, [
        ['h4', 'Structure'], ['ul', [
        ...
        ['div', {class: 'hm_colors', efy_select: ''}, [
            ['div', {class: 'hm_color hm-fill-bg efy_card_filter', style: 'background: var(---color)'}, 'accent'],
            ['div', {class: 'hm_color efy_card_filter', style: 'background: var(---color), var(---color_trans); background-clip: text, border-box; -webkit-text-fill-color: transparent !important;'}, 'accent-x'],
            ['div', {class: 'hm_color hm-fill-bg efy_card_filter', style: 'background: var(---text)'}, 'text'],
            ['div', {class: 'hm_color efy_card_filter', style: 'background: var(---text-x)'}, 'text-x'],
            ['div', {class: 'hm_color hm-fill-bg efy_card_filter', style: 'background: var(---text-xx)'}, 'text-xx'],
        ...
        ['h4', 'Radius'],
        ['p', 'All corners'],
        ['div', {class: 'hm_colors hm_radius', efy_select: ''}, [
            ['div', {class: 'hm_gap efy_card_filter'}, [['div', {style: 'border-radius: var(---radius-xx)'}], ['p', 'radius-xx']]],
            ['div', {class: 'hm_gap efy_card_filter'}, [['div', {style: 'border-radius: var(---radius-x)'}], ['p', 'radius-x']]],
            ['div', {class: 'hm_gap efy_card_filter'}, [['div', {style: 'border-radius: var(---radius)'}], ['p', 'radius']]],
            ['div', {class: 'hm_gap efy_card_filter'}, [['div', {style: 'border-radius: var(---radius-o)'}], ['p', 'radius-o']]]
        ]],
        ['p', {style: 'margin-top: 15rem'}, 'Partial corners (coming soon)'],
        ['div', {class: 'hm_colors hm_radius', efy_select: ''}, [
            ['div', {class: 'hm_gap r1 xx efy_card_filter'}, [['div'], ['p', 'radius-1-xx']]],
            ['div', {class: 'hm_gap r1 x efy_card_filter'}, [['div'], ['p', 'radius-1-x']]],
            ['div', {class: 'hm_gap r1 efy_card_filter'}, [['div'], ['p', 'radius-1']]],
            ['div', {class: 'hm_gap r1 o efy_card_filter'}, [['div'], ['p', 'radius-1-o']]]
        ]],
        ['div', {class: 'hm_colors hm_radius', efy_select: ''}, [
            ['div', {class: 'hm_gap r2 xx efy_card_filter'}, [['div'], ['p', 'radius-2-xx']]],
            ['div', {class: 'hm_gap r2 x efy_card_filter'}, [['div'], ['p', 'radius-2-x']]],
            ['div', {class: 'hm_gap r2 efy_card_filter'}, [['div'], ['p', 'radius-2']]],
            ['div', {class: 'hm_gap r2 o efy_card_filter'}, [['div'], ['p', 'radius-2-o']]]
        ]],
        ['div', {class: 'hm_colors hm_radius', efy_select: ''}, [
            ['div', {class: 'hm_gap r3 xx efy_card_filter'}, [['div'], ['p', 'radius-3-xx']]],
            ['div', {class: 'hm_gap r3 x efy_card_filter'}, [['div'], ['p', 'radius-3-x']]],
            ['div', {class: 'hm_gap r3 efy_card_filter'}, [['div'], ['p', 'radius-3']]],
            ['div', {class: 'hm_gap r3 o efy_card_filter'}, [['div'], ['p', 'radius-3-o']]]
        ]],
        ['div', {class: 'hm_colors hm_radius', efy_select: ''}, [
            ['div', {class: 'hm_gap r4 xx efy_card_filter'}, [['div'], ['p', 'radius-4-xx']]],
            ['div', {class: 'hm_gap r4 x efy_card_filter'}, [['div'], ['p', 'radius-4-x']]],
            ['div', {class: 'hm_gap r4 efy_card_filter'}, [['div'], ['p', 'radius-4']]],
            ['div', {class: 'hm_gap r4 o efy_card_filter'}, [['div'], ['p', 'radius-4-o']]]
        ]], hr,

        ['h4', 'Gap'],
        ['p', 'They can be used as gaps, margins, paddings, etc.'],
        ['div', {class: 'hm_colors', efy_select: ''}, [
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---gap-xx);'}, [['div'], ['p', 'gap-xx']]],
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---gap-x);'}, [['div'], ['p', 'gap-x']]],
            ['div', {class: 'hm_gap efy_card_filter'}, [['div'], ['p', 'gap']]],
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---gap-o);'}, [['div'], ['p', 'gap-o']]],
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---gap-oo);'}, [['div'], ['p', 'gap-oo']]]
        ]], hr,
        ['h4', 'Size'],
        ['p', 'Mostly used for button heights, inputs & thumbnails'],
        ['div', {class: 'hm_colors', efy_select: ''}, [
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---size0);'}, [['div'], ['p', 'size-x']]],
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---size);'}, [['div'], ['p', 'size']]],
            ['div', {class: 'hm_gap efy_card_filter', style: '---demo: var(---size-o);'}, [['div'], ['p', 'size-o']]]
        ]], hr,
        ['h4', 'Padding'],
        ['p', 'Mostly used for buttons. The examples have a 15rem container inside the padding to simulate a real case.'],
        ['div', {class: 'hm_colors hm_padding', efy_select: ''}, [
            ['div', {class: 'hm_gap efy_card_filter'}, [
        ...
        ['div', {class: 'hm_colors', efy_select: ''}, [
            ['div', {id: 'hm_size0', style: 'background: var(---card)'}, [['p', {style: 'padding-left: 10rem; border-left: var(---border_size) solid var(---text);'}, 'border-size']]],
            ['div', {id: 'hm_size0', style: 'background: var(---card)'}, [['p', {style: 'padding-left: 10rem; border-left: var(---border_size2) solid var(---text);'}, 'border-size-o']]]
        ]]
    ]],

    ['div', {efy_content: 'home_tab_modules', class: 'efy_card_filter_off'}, [
        ['h4', 'Info Coming Soon'], ['p', 'Stay tuned...']
    ]],
    ['div', {efy_content: 'home_tab_themes', class: 'efy_card_filter_off'}, [
        ['h4', 'Info Coming Soon'], ['p', 'Stay tuned...']
    ]],

    ['div', {efy_content: 'home_tab_icons', class: 'efy_card_filter_off'}, [
        ['div', {style: 'display: flex; gap: var(---gap); width: 100%'}, [
            ['div', {
                class: 'efy_square_btn efy_card_filter',
        ...
        ['div', {div: '', class: 'efy_card_filter_off'}, [['div', {id: 'hm_icons'}]]]
    ]],

    ['div', {efy_content: 'home_tab_shapes', class: 'efy_card_filter_off'}, [
        ['p', `Alpha stage, not ready to be used yet...`],
        ['div', {class: 'home_shapes'}, shapes]
    ]],

    ['div', {efy_content: 'home_tab_modes', class: 'efy_card_filter_off'}, [
        ['ul', [
    ...
    ['div', {efy_content: 'home_tab_add', class: 'efy_card_filter_off'}, [
        ['p', [
    ...
    ['div', {efy_content: 'home_tab_color_picker', class: 'efy_card_filter_off', efy_searchable: 'color_picker'}, [
    ...
    ['div', {efy_content: 'home_tab_clock', class: 'efy_card_filter_off'}, [
    ...
    ['div', {efy_content: 'home_tab_timer', class: 'efy_card_filter_off'}, [
        ['div', {class: 'efy_flex preview'}, [
    ...
    ['div', {efy_content: 'home_tab_select_menu', class: 'efy_card_filter_off'}, [
    ...
    ['div', {efy_content: 'home_tab_tabs', class: 'efy_card_filter_off'}, [
        ['div', {'efy_tabs': 'hm2'}, [
            ['div', {class: 'efy_tabs'}, [
...
$event(document, 'click', (event)=>{ target = event.target;
    if (target.matches('#hm_notify_test')) $notify('short', 'Short Notification', 'Disappears in 5s')
    if (target.matches('.questions')) home_tab_questions.click();
    if (target.matches('.common_actions')) home_tab_common_actions.click();
    if (target.matches('.components')) {home_tab_group_components.click(); home_tab_clock.click()}
    if (target.matches('.functions')) {home_tab_group_functions.click(); home_tab_add.click()}
    if (target.matches('.icons')) home_tab_icons.click();
});
...
update_3d_colors =()=>{
    const color0deg = $css_prop('---color').replace(efy.color_angle || '165deg', '0deg'),
    color_trans_0deg = $css_prop('---color_trans').replace(efy.color_angle || '165deg', '0deg'),
    ...
    $css_prop('---color_0deg', color0deg);
    $css_prop('---color_trans_0deg', color_trans_0deg);
    $css_prop('---color_first', `oklch(${color_first[1]} ${color_first[2]} ${color_first[3]} / ${color_last[4]})`);
    $css_prop('---color_last', `oklch(${color_last[1]} ${color_last[2]} ${color_last[3]} / ${color_last[4]})`);
    $css_prop('---color_trans_first', `oklch(${trans_first[1]} ${trans_first[2]} ${trans_first[3]} / ${(trans_first[4] / 3).toFixed(2)})`);
    $css_prop('---color_trans_last', `oklch(${trans_last[1]} ${trans_last[2]} ${trans_last[3]} / ${(trans_last[4] / 3).toFixed(2)})`);
};
